...
function AnnouncementBar() {
  return (
    <div data-gsap-bar className="hidden bg-dark-brown text-background md:block">
      <div className="mx-auto flex h-10 max-w-[1760px] items-center justify-between gap-4 px-4 text-[10px] sm:px-5 sm:text-[11px] md:px-10">
        <a
          href="#shipping"
        ...
        <div className="flex shrink-0 items-center gap-4">
          ...
          >
            ...
            <span className="hidden sm:inline">Call Us: +91 99865 87575</span>
